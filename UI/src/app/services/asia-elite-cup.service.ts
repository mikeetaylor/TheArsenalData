...
export class AsiaEliteCupService {

formData!: AsiaEliteCupInterface;
...
//readonly PhotoURL="http://localhost:59229/Photos";
  ...
  getAsiaEliteCupList(year:string):Observable<any[]>{
    return this.http.get<any>(this.APIUrl+'/{year}/Asia_Elite_Cup' + year);
  }

  getNextPlayer(val:number, year:any):Observable<any[]>{
    return this.http.get<any>(this.APIUrl+ '/{year}/Asia_Elite_Cup' + year + '/PlayerID=' + val);
  }
